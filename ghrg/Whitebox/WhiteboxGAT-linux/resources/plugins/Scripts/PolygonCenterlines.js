...
function createDialog(args) {
	if (args.length !== 0) {
		...
		sd.addDialogFile("Input vector file", "Input Raster File:", "open", "Vector Files (*.shp), SHP", true, false);
		sd.addDialogFile("Output vector file", "Output Raster File:", "save", "Vector Files (*.shp), SHP", true, false);
