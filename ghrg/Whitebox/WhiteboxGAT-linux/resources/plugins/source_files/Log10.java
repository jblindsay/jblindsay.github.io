...
/**
 * This tool creates a new raster in which each grid cell is calculated as the base 10 logarithm of the value of the corresponding grid cell in the input raster.
 *
 * @author Dr. John Lindsay email: jlindsay@uoguelph.ca
 */
public class Log10 implements WhiteboxPlugin {
    ...
    public String getToolDescription() {
    	return "Returns the base 10 logarithm of values in a raster.";
    }
        ...
        try {
            ...
            for (row = 0; row < rows; row++) {
                ...
                for (col = 0; col < cols; col++) {
                    z = data[col];
                    if (z != noData) {
                        outputFile.setValue(row, col, Math.log10(z));
                    }
