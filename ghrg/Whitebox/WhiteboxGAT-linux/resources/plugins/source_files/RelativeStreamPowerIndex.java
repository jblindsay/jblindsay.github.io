...
/**
 * This tool can be used to calculate the relative stream power index.
 *
 * @author johnlindsay
 */
public class RelativeStreamPowerIndex implements WhiteboxPlugin {
    ...
    public String getName() {
        return "RelativeStreamPowerIndex";
    }
    ...
    public String getDescriptiveName() {
    	return "Relative Stream Power Index";
    }
    ...
    public String getToolDescription() {
    	return "Calculates the relative stream power index.";
    }
    ...
    public void run() {
        ...
        for (i = 0; i < args.length; i++) {
            if (i == 0) {
                ...
                powerValue = Double.parseDouble(args[i]);
            }
        }
        ...
        try {
            if (powerValue < 0.1) { powerValue = 0.1; }
            if (powerValue > 20) { powerValue = 20; }
