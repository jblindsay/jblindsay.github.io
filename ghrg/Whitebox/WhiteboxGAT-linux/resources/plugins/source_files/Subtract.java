...
/**
 * This tool creates a new raster in which each grid cell is equal to the subtraction of the corresponding grid cells in two input rasters or one input raster and a constant value.
 *
