...
/**
 * This tool can be used to find the minimum value in each cell of a grid from a set of input images.
 * @author Dr. John Lindsay email: jlindsay@uoguelph.ca
 */
public class MinOverlay implements WhiteboxPlugin {
    ...
    public String getToolDescription() {
    	return "Evaluates the minimum value for each grid cell from a group of input rasters.";
    }
    /**
