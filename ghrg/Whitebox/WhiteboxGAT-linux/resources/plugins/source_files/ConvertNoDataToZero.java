...
public class ConvertNoDataToZero implements WhiteboxPlugin {
    ...
    public String getToolDescription() {
    	return "The ConvertNoDataToZero tool can be used to convert the "
                + "NoData values in a raster to zero.";
    }
    /**
