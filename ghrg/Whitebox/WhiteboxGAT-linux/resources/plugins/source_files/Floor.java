...
/**
 * This tool returns the largest (closest to positive infinity) value that is less than or equal to the values in a raster.
 *
 * @author Dr. John Lindsay email: jlindsay@uoguelph.ca
 */
public class Floor implements WhiteboxPlugin {
    ...
    public String getToolDescription() {
        return "Returns the largest (closest to positive infinity) value that is less than or equal to the values in a raster.";
    }
