 ...
 */
public class Power implements WhiteboxPlugin {
    ...
    public String getToolDescription() {
        return "Raises the values in grid cells of one rasters, or a constant value, by the values in the grid cells of another raster, or constant value.";
    }
            ...
            if (image1Bool && image2Bool) {
                ...
                for (row = 0; row < rows; row++) {
                    ...
                    for (col = 0; col < cols; col++) {
                        ...
                        if ((z1 != noData1) && (z2 != noData2)) {
                            outputFile.setValue(row, col, Math.pow(z1, z2));
                        } else {
                ...
                for (row = 0; row < rows; row++) {
                    ...
                    for (col = 0; col < cols; col++) {
                        z1 = data1[col];
                        if (z1 != noData) {
                            outputFile.setValue(row, col, Math.pow(z1, constant2));
                        }
                    }
                    progress = (int) (100f * row / (rows - 1));
                    if (progress != oldProgress) {
                ...
                for (row = 0; row < rows; row++) {
                    ...
                    for (col = 0; col < cols; col++) {
                        z2 = data2[col];
                        if (z2 != noData) {
                            outputFile.setValue(row, col, Math.pow(constant1, z2));
                        }
                    }
                    progress = (int) (100f * row / (rows - 1));
                    if (progress != oldProgress) {
