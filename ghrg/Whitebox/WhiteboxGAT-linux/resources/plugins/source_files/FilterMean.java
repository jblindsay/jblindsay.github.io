...
/**
 * This tool performs a mean filter on a raster image, which can be used to emphasize the longer-range variability in an image, effectively acting to smooth the image. 
 * @author Dr. John Lindsay email: jlindsay@uoguelph.ca
 */
public class FilterMean implements WhiteboxPlugin {
    ...
    public String getToolDescription() {
    	return "Performs a mean filter on an image.";
    }
     /**
