...
/**
 * This tool can be used to perform a Gaussian filter on a raster image, which can be used to emphasize the longer-range variability in an image, effectively acting to smooth the image.
