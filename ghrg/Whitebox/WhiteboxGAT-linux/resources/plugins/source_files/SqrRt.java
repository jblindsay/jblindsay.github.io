...
/**
 * This tool creates a new raster in which each grid cell is equal to the square root of the value of the corresponding grid cell in the input raster.
 *
 * @author Dr. John Lindsay email: jlindsay@uoguelph.ca
 */
public class SqrRt implements WhiteboxPlugin {
    ...
    public String getToolDescription() {
        return "Returns the square root of the values in a raster.";
    }
        ...
        try {
            ...
            for (row = 0; row < rows; row++) {
                ...
                for (col = 0; col < cols; col++) {
                    z1 = data1[col];
                    if (z1 != noData) {
                        outputFile.setValue(row, col, Math.sqrt(z1));
                    } else {
