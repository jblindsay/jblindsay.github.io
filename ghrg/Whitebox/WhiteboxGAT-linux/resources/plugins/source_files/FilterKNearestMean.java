...
/**
 * This tool performs a k-nearest mean filter on a raster image, which can be used to emphasize the longer-range variability in an image, effectively acting to smooth the image.
