...
/**
 * This tool can be used to assign the Horton-Strahler stream order to each link in a stream network.
 *
 * @author Dr. John Lindsay email: jlindsay@uoguelph.ca
 */
public class StreamOrder implements WhiteboxPlugin {
    ...
    public String getDescriptiveName() {
    	return "Horton-Strahler Stream Order";
    }
    ...
    public String getToolDescription() {
    	return "Assigns the Horton-Strahler stream order to each link in a stream network.";
    }
