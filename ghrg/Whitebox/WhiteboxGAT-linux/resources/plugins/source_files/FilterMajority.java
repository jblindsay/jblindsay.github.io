...
/**
 * This tool performs a majority (or modal) filter on a raster image, which assigns each cell in the output grid the most commonly occurring value, i.e. mode, in a moving window centred on each grid cell.
