...
public class FindPatchOrClassEdgeCells implements WhiteboxPlugin {
    ...
    public String getName() {
        return "FindPatchOrClassEdgeCells";
    }
    /**
    ...
    public String getDescriptiveName() {
    	return "Find Patch Or Class Edge Cells";
    }
    /**
    ...
    public String getToolDescription() {
    	return "Finds all cells located on the edge of patch or class features.";
    }
    /**
                ...
                for (col = 0; col < cols; col++) {
                    ...
                    if (z != noData) {
                        if (z != 0) {
                            val = 0;
                            for (i = 0; i < 8; i++) {
                                if (image.getValue(row + dY[i], col + dX[i]) != z) {
                                    val = z;
                                    break;
                                }
                            }
