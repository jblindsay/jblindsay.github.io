 ...
 */
public class NumDownslopeNeighbours implements WhiteboxPlugin {
    ...
    public String getDescriptiveName() {
    	return "Number of Downslope Neighbours";
    }
    ...
    public String getToolDescription() {
    	return "Calculates the number of downslope neighbours of each grid cell in a DEM.";
    }
            ...
            for (row = 0; row < rows; row++) {
                for (col = 0; col < cols; col++) {
                    ...
                    if (z != noData) {
                        ...
                        output.setValue(row, col, numDownslopeNeighbours);
                    }
                }
                if (cancelOp) {
                    cancelOperation();
