...
/**
 * This tool creates a new raster in which each grid cell is calculated as e to the power of the value of the corresponding grid cell in the input raster.
 *
 * @author Dr. John Lindsay email: jlindsay@uoguelph.ca
 */
public class Exp implements WhiteboxPlugin {
    ...
    public String getToolDescription() {
        return "Returns the exponential (base e) of values in a raster.";
    }
        ...
        try {
            ...
            for (row = 0; row < rows; row++) {
                ...
                for (col = 0; col < cols; col++) {
                    z1 = data1[col];
                    if (z1 != noData) {
                        outputFile.setValue(row, col, Math.exp(z1));
                    }
                }
