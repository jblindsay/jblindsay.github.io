 ...
 */
public class ArcCos implements WhiteboxPlugin {
    ...
    public String getToolDescription() {
    	return "Returns the inverse cosine (arccos) of each values in a raster.";
    }
        ...
        try {
            ...
            for (row = 0; row < rows; row++) {
                ...
                for (col = 0; col < cols; col++) {
                    z = data[col];
                    if (z != noData) {
                        outputFile.setValue(row, col, Math.acos(z));
                    }
